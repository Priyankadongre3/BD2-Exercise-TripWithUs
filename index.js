...
function sortHotelpricingInAscendDescndOrder(pricing, hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  hotelsCopy.sort((hotel1, hotel2) =>
    sortHotelpricingInAscendDescndOrder(pricing, hotel1, hotel2)
  );
  res.json(hotelsCopy);
});

function sortHotelratingsInAscendDescndOrder(rating, hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  hotelsCopy.sort((hotel1, hotel2) =>
    sortHotelratingsInAscendDescndOrder(rating, hotel1, hotel2)
  );
  res.json(hotelsCopy);
});

function sortHotelreviewsInAscendDescndOrder(reviews, hotel1, hotel2) {
  if (reviews === 'low-to-high') {
    return hotel1.reviews - hotel2.reviews;
  } else if (reviews === 'high-to-low') {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  hotelsCopy.sort((hotel1, hotel2) =>
    sortHotelreviewsInAscendDescndOrder(reviews, hotel1, hotel2)
  );
  res.json(hotelsCopy);
});
...
app.get('/hotels/filter/amenity', (req, res) => {
  let amenity = req.query.amenity.trim();
